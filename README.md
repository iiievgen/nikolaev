...
Раньше использовался случайный подбор 
изменяем алгоритм работы функции на Бинарный и меняем название на 
smart_predict
...
### Результаты:  
Среднее количество попыток сократилось с ~100 до 7 (теоретический минимум для бинарного поиска).
